<div class="flex justify-center w-full my-0 md:my-4">
    <form action="/document/{{ $data['document']->id }}" enctype="multipart/form-data" method="POST">
        @csrf
        @method('PUT')
        <div class="flex flex-col justify-center w-full gap-8 px-4 py-8 border shadow-md md:w-96">
            ...
            <div>
                <x-utils.form.input label="Nama Sekolah" id="school_id" type="text" name="school_id" :value="old('school_id')"
                    required autofocus />
