    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="grid grid-cols-1 gap-4">
            ...
            <div class="grid grid-cols-1 gap-8">
                <!-- Name -->
                <div>
                    <x-utils.form.input label="Name" id="name" type="text" name="name" :value="old('name')"
                        required autofocus />
                ...
                <!-- Password -->
                <div>
                    <x-utils.form.input label="Password" id="password" type="password" name="password"
                ...
                <!-- Confirm Password -->
                <div>
                    <x-utils.form.input label="Confirm Password" id="password_confirmation" type="password"
