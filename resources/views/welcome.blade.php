            ...
            <div>
                <nav class="flex h-9 items-center justify-between" aria-label="Global">
                    <div class="flex lg:min-w-0 lg:flex-1" aria-label="Global">
                        <a href="/" class="-m-1.5 p-1.5">
                            <div class="flex gap-2 items-center">
                                ...
                                <span class="text-lg text-gray-500">Legalisir App</span>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-center lg:gap-x-12">
                        <a href="#" class="font-semibold text-gray-900 hover:text-gray-900">Benefit</a>
                        <a href="#" class="font-semibold text-gray-900 hover:text-gray-900">Our Partner</a>
                        <a href="#" class="font-semibold text-gray-900 hover:text-gray-900">Registration Partner</a>
                    </div>
                    <div class="hidden lg:flex lg:min-w-0 lg:flex-1 lg:items-center lg:gap-2 lg:justify-end">
                        @if (Route::has('login'))
                            @auth
                ...
                <div role="dialog" aria-modal="true">
                    <div focus="true" class="fixed inset-0 z-10 overflow-y-auto bg-white px-6 py-6 lg:hidden">
                        <div class="flex h-9 items-center justify-between">
                            <div class="flex">
                                <a href="#" class="-m-1.5 p-1.5">
                                    <span class="sr-only">Legalisir App</span>
                                    <img class="h-8"
        ...
        <main>
            <div class="relative px-6 lg:px-8">
                <div class="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
                    <div>
                        <div>
                            <h1 class="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">Legalisir App</h1>
                            <p class="mt-6 text-lg leading-8 text-gray-600 sm:text-center">Sistem Informasi Legalisir
                                Ijazah Sekolah</p>
